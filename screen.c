...
Position getscreensize(void){
	...
	// position, the terminal sgould retuen a string back to the program
	...
	gotoXY(999,999);		//for the cursor to the bottom right corner
	printf("%c[6n",ESC);
...
#include <string.h>
	...
	if(strlen(ret)>0){		//in this case we got a sursor position report
